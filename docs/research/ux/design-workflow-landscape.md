...
| [Figma Make](https://www.figma.com/solutions/ai-prototype-generator/) | Natural-language interactive prototypes with visual and code editing | Worth testing if the Figma agent path makes canvas expertise unnecessary; overlaps the Figma Make and Figma agent row in the canvases table | Close reserve |
