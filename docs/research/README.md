...
The files in this directory are working research notes, not canonical requirements. Re-check current upstream projects before making decisions because this tooling landscape changes quickly.
