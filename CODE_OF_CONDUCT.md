...
Nothing else in the wording is changed. Heading levels are shifted
down by one, to nest the reproduced document under this file's own
title. That is a formatting choice, made when converting the source
from HTML to Markdown. It does not change any word.
...
When an incident does occur, it is important to report it promptly. To report a possible violation, report it to the contact address published on this project's organisation page on GitHub.
